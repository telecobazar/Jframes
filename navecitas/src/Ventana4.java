...
public class Ventana4 extends JFrame implements ActionListener {
    ...
    private void inicializarComponentes() {
        ...
        texto1.setText(" ¡¡¡ Fichero exportado satisfactoriamente !!! "); 
        texto2.setText("¡¡¡ EL UNIVERSO YA ESTÁ TRANQUILO !!!");   // colocamos un texto a la etiqueta
        texto1.setBounds(30, 5, 500, 100);   // colocamos posicion y tamaño al texto (x, y, ancho, alto)
        texto2.setBounds(30, 30, 400, 100);
         // colocamos posicion y tamaño a la caja2 (x, y, ancho, alto)
