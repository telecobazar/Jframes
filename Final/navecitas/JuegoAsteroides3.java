...
public static void main (String[] args) {
	...
	Set<Jugador> jugadores = new HashSet<Jugador>();
		 ...
		 EscenarioAsteroides m = new EscenarioAsteroides(600,600);       // Creamos el escenario. 
	     Coordenada c1 = new Coordenada(0,250);     					 // Coordenadas para la nave 1
	    // Coordenada c2 = new Coordenada(0,250);	 						 // Coordenadas para la nave 2
	     Coordenada c3 = new Coordenada(200,350);						 // Coordenadas para el asteroide 1 
	     Coordenada c4 = new Coordenada(500,100);						 // Coordenadas para el asteroide 2
	     Coordenada c5 = new Coordenada(150,100);						 // Coordenadas para la nave extraterrestre
	     Coordenada c6 = new Coordenada(375,147);						 // Coordenadas para Roger el extraterrestre
	     ...
	     Rectangulo r3 = new Rectangulo(c3,40,40);						 // Rectangulo para pintar los asteroides  
	     Rectangulo r4 = new Rectangulo(c4,40,40); 						 // Rectangulo para pintar los asteroides  
	     Rectangulo r5 = new Rectangulo(c5,60,60);						 // Rectangulo para pintar una nave extraterrestre 
	     Rectangulo r6 = new Rectangulo(c6,100,100);					 // Rectangulo para pintar a Roger el extraterrestre
	  ...
	  // Creamos las naves y asteroides 
	    ...
	    if (nivel==4) {
     		...
     		while (!salir) {
     			...
     			}catch(ExcepcionJuego e){} catch (InterruptedException e) {
					e.printStackTrace();
				}
			}
     		...
     		if(masPartidas) {
     			/*
     			if(EscenarioAsteroides.puntuacion<3000)
     				nivel=1;
     			if(EscenarioAsteroides.puntuacion>=3000 &&EscenarioAsteroides.puntuacion<9000)
     				nivel=2;
     			if(EscenarioAsteroides.puntuacion>=9000 &&EscenarioAsteroides.puntuacion<15000)
     				nivel=3;
     			if(EscenarioAsteroides.puntuacion>=15000)
     				nivel=4;
     			*/
     			nivel++;
