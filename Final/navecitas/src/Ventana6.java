...
public class Ventana6 extends JFrame implements ActionListener {
    ...
    private void inicializarComponentes() {
        ...
        texto1.setText("    Deseas actualizar las puntuaciones? "); 
        texto1.setBounds(95, 5, 500, 100); 			// colocamos posicion y tama̱o al texto (x, y, ancho, alto)
    ...
    public void actionPerformed(ActionEvent e) {
		 ...
		 if(e.getActionCommand().equals("si")){//podemos comparar por el contenido del boton
	            JOptionPane.showMessageDialog(this, "Puntuaciones guardadas correctamente");
	            respuesta = boton1.getText();
	        }
		 if(e.getActionCommand().equals("no")){//podemos comparar por el contenido del boton
	            JOptionPane.showMessageDialog(this, "Las puntuaciones no han sido  guardadas");
